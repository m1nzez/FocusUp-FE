...
final class BottomSheetViewController: UIViewController {
    ...
    init(contentViewController: UIViewController, defaultHeight: CGFloat, cornerRadius: CGFloat = 26, dimmedAlpha: CGFloat = 0.4, isPannedable: Bool = false) {
